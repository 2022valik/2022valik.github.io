         ...
         $('.password').on("input click", function validatePass() { //добавить обработчик на клик
             ...
             if (password.match(/^[0-9A-Za-z\s]+$/) != null) {
                 $(checkAlph).addClass('check')
             }
             if (password.match(/^[0-9A-Za-z\s]+$/) === null) {
                 $(checkAlph).removeClass('check')
             }
             if ( password.match(/[A-Z]/) != null && password.match(/[a-z]/) != null && password.match(/[1-9]/) != null && password.length > 7 && password.match(/^[0-9A-Za-z\s]+$/) != null ){
